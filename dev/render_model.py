...
Run from the repository root: python3 dev/render_model.py
...
<a class="stage" href="/lab.html?mode=city&city=stuttgart&overlays=areas,scenario&scenario=close-milaneo">← BACK TO THE EXPLORER</a></header>
